...
quant_esm2 = quant_esm2.cuda("cuda:2")
...
for i in range(50):
    ...
    with torch.no_grad():
        results = quant_esm2(batch_tokens.cuda("cuda:2"), repr_layers=[33], return_contacts=True)
...
mode = load_model_act_stats(quant_esm2, act_stats_save_path, act_clip_method="top_5")
